...
/**
 * Axios Concurreny Library, but typescript.
 *
 * See https://github.com/bernawil/axios-concurrency
 */
export const ConcurrencyManager = (axios: AxiosInstance, MAX_CONCURRENT = 10) => {
  if (MAX_CONCURRENT < 1) throw 'Concurrency Manager Error: minimum concurrent requests is 1'
  let instance = {
    queue: [],
    running: [],
    shiftInitial: () => {
